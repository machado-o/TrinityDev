...
class CoberturaService {
  ...
  static async findAll() {
    const objs = await Cobertura.findAll({ include: { all: true, nested: true } });
    return objs;
  }

  static async findByPk(req) {
    const { id } = req.params;
    const obj = await Cobertura.findByPk(id, { include: { all: true, nested: true } });
    return obj;
  }
  ...
  static async create(req) {
    ...
    return await Cobertura.findByPk(obj.id, { include: { all: true, nested: true } });
  }
