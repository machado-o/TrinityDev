...
class CategoriaVeiculoService {
  ...
  static async findAll() {
    const objs = await CategoriaVeiculo.findAll({ include: { all: true } });
    return objs;
  }

  static async findByPk(req) {
    const { id } = req.params;
    const obj = await CategoriaVeiculo.findByPk(id, { include: { all: true } });
    return obj;
  }
  ...
  static async create(req) {
    ...
    return await CategoriaVeiculo.findByPk(obj.id, { include: { all: true } });
  }
